...
const Pmenu = () => {
  ...
  useEffect(()=>{
    ...
    const filterproduct=products.filter((item)=>item.category=='Japanese Food');
    setPmenu(filterproduct);
  },[])
  ...
  return (
    <div className="section" id="japanesefood"> 
    <h1 className="text-center font-bold text-5xl pb-16">Japanese Food</h1>
